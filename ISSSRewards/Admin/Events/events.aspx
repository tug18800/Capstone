...
<!--TITLE-->
        <div class="card container shadow">
            <div class="card-title mt-3 mb-0"><p class="lead text-center text-large">Search Events</p></div>
            <hr />
            <div class="card-body">

<!--SEARCH FUNCTION-->
                <div class="row mb-4 justify-content-center">
                    <div class="col-2 text-center lead"><p>Enter Event ID</p></div>
                    ...
                    <div class="col-1"><asp:Button runat="server" ID="btnAll" CssClass="btn bg-owl text-light d-block ml-auto" Text="See All Events" OnClick="btnAll_Click"/></div>
                    </div>
                </div>
